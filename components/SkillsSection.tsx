    ...
    <Reveal delay={0.12}>
      <section className="py-8 sm:py-12 px-4 sm:px-6 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-6 rounded-2xl bg-black/70 border border-white/10 text-center text-white"> <div className="text-xl sm:text-2xl font-black text-[#F58220] mb-1">MIG/TIG Sim</div><div className="text-sm text-gray-300">Welding scenarios</div></div>
        ...
        <div>
          <h3 className="text-3xl font-black mb-3 text-black">SKILLS ARE <span className="text-[#F58220]">MEASURED</span>, NOT ASSUMED</h3>
          ...
          <a href="#" className="bg-[#F58220] text-white px-4 py-2 rounded-full font-bold hover:bg-[#c94e30]">View Curriculum</a>
        </div>
        </div>
      </section>
    </Reveal>
