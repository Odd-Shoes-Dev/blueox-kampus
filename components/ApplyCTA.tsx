    ...
    <Reveal delay={0.30}>
      <section id="apply" className="py-12 sm:py-20 px-4 sm:px-6 text-center bg-gradient-to-b from-black/50 to-black">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="https://wa.me/3197010209759" target="_blank" rel="noopener noreferrer" className="bg-[#f38131] px-12 py-6 rounded-2xl font-black uppercase tracking-widest shadow-2xl hover:bg-orange-600 transition inline-block text-center">Join Academy</a>
