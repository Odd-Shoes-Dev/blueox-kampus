    ...
    <Reveal delay={0.27}>
      <section className="py-8 sm:py-12 px-4 sm:px-6 bg-black">
        ...
        <div className="inline-flex gap-4">
          <a href="https://wa.me/3197010209759" target="_blank" rel="noopener noreferrer" className="bg-[#ff4040] text-black px-6 py-3 rounded-full font-bold">JOIN THE ACADEMY</a>
