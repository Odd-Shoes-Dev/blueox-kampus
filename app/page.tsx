...
export default function Page() {
  return (
    <>
      ...
      {/* HERO SECTION */}
      <section className="relative min-h-screen flex items-center justify-center bg-black pt-20 sm:pt-24 md:pt-32">
          ...
          <Reveal delay={0.1}>
            <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-16">
              ...
              <div className="text-center lg:text-left flex-1">
                <h1 className="blueox-heading text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight text-white mb-4 sm:mb-6">
